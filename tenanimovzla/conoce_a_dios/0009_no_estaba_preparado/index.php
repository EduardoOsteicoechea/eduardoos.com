<?php
   ...
   $page_title = "tenanimovzla - Conoce a Dios - ¡No estaba preparado!";
   $page_name = "no_estaba_preparado";
   ...
   $page_main_content = new main_content_001(
      ...
      "tenanimovzla/conoce_a_dios/0009_no_estaba_preparado/article_data.json",
      [
         ["Inicio","inicio"],
         ["Conoce a Dios","tenanimovzla/conoce_a_dios/"],
         ["¡No estaba preparado!","tenanimovzla/conoce_a_dios/0009_no_estaba_preparado/"],
      ]
   );
