<?php
   ...
   $page_title = "tenanimovzla - Conoce a Dios - ¡Llama pronto al escogido!";
   $page_name = "llama_pronto_al_escogido";
   ...
   $page_main_content = new main_content_001(
      ...
      "tenanimovzla/conoce_a_dios/0008_llama_pronto_al_escogido/article_data.json",
      [
         ["Inicio","inicio"],
