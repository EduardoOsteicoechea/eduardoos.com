<?php
   ...
   $page_title = "tenanimovzla - Conoce a Dios - ¿Dónde quedó la admiración?";
   $page_name = "donde_quedo_la_admiracion";
   ...
   $page_main_content = new main_content_001(
      ...
      "tenanimovzla/conoce_a_dios/0006_donde_quedo_la_admiracion/article_data.json",
      [
         ["Inicio","inicio"],
         ["Conoce a Dios","tenanimovzla/conoce_a_dios/"],
         ["¿Dónde quedó la admiración?","tenanimovzla/conoce_a_dios/0006_donde_quedo_la_admiracion/"],
      ]
   );
