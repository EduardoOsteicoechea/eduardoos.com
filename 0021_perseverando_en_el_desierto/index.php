<?php
   ...
   $page_title = "Perseverando en el desierto";
   $page_name = "perseverando_en_el_desierto";
   ...
   $page_main_content = new main_content_001(
      ...
      "tenanimovzla/conoce_a_dios/0022_perseverando_en_el_desierto/article_data.json",
      [
         ["Inicio","inicio"],
         ["Conoce a Dios","tenanimovzla/conoce_a_dios/"],
         ["Los sanos quedan fuera","tenanimovzla/conoce_a_dios/0022_perseverando_en_el_desierto/"],
      ]
   );
